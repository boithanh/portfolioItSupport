...
<div class="container mx-auto flex">
  <div class="border-custom p-5 max-sm:w-full sm:w-10/12 justify-items-center mx-auto">
    ...
    <ul class="max-sm:text-2xl sm:text-4xl max-sm:leading-10 sm:leading-20 mb-3">
      ...
      <li>Basic web skills: HTML, CSS (for internal system troubleshooting)</li>
      <li>Basic website maintenance and interface adjustments using HTML/CSS for company internal sites</li>
    </ul>
  </div>
</div>
`;